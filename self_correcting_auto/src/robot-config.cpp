...
motor lift2 = motor(PORT3, ratio18_1, false);
...
motor lift1 = motor(PORT15, ratio18_1, true);
motor tray2 = motor(PORT11, ratio36_1, false);
motor claw = motor(PORT4, ratio36_1, false);
gps gyros = gps(PORT20, -193.04, 6.35, mm, 270);
//triport ThreeWirePort = vex::triport( vex::PORT22 );
encoder Eleft = encoder(Brain.ThreeWirePort.G);
encoder Eright = encoder(Brain.ThreeWirePort.C);
encoder Eback = encoder(Brain.ThreeWirePort.E);
