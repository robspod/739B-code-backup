...
void outtop(){
  ...
  backtop.spin(vex::directionType::rev,100,vex::velocityUnits::pct);
}
void outback(){
  top2.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
  middle.spin(vex::directionType::rev,100,vex::velocityUnits::pct);
  bottom.spin(vex::directionType::rev,100,vex::velocityUnits::pct);
  backtop.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
}
void spinstop(){
  top2.stop(vex::brakeType::brake);
  middle.stop(vex::brakeType::brake);
  bottom.stop(vex::brakeType::brake);
  backtop.stop(vex::brakeType::brake);
...
void usercontrol(void) {
  ...
  */
  ...
  // main wheel drive
  Left.spin(vex::directionType::fwd, (Controller1.Axis2.value())/speed , vex::velocityUnits::pct); //(Axis3+Axis4)/2
  Right.spin(vex::directionType::fwd, (Controller1.Axis3.value())/speed, vex::velocityUnits::pct);//(Axis3-Axis4)/2
