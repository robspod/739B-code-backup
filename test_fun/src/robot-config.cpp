...
accelerometer AccelYAxis = accelerometer(Brain.ThreeWirePort.B);
accelerometer xaxes = accelerometer(Brain.ThreeWirePort.A);
accelerometer AccelZaxes = accelerometer(Brain.ThreeWirePort.C);
motor29 Motor393E = motor29(Brain.ThreeWirePort.E, false);
