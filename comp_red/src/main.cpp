  ...
  while (1) {
        ...
        if(Controller1.ButtonL1.pressing()){
            if(speed == 1){
                ...
                Controller1.Screen.print("Oh FUCK ME");
                Controller1.rumble("-");
            }
            else{
                speed -= 1;
        ...
        if(Controller1.ButtonL2.pressing()){
           if(Controller1.ButtonR2.pressing()){
            ...
            if(speed == 5){
                Controller1.Screen.clearScreen();
                Controller1.Screen.setCursor(1, 1); 
                Controller1.Screen.print("STOP DAVE");
                Controller1.rumble("-.");
           }
       ...
       if(Controller2.ButtonL1.pressing()){
            if(speed2 == 1){
                ...
                Controller2.Screen.print("STOP you Jew");
                Controller2.rumble("-");
            }
            else{
                speed2 = speed2 - 1;
        ...
        if(Controller2.ButtonL2.pressing()){
           if(Controller2.ButtonR2.pressing()){
            ...
            if(speed2 == 5){
                Controller2.Screen.clearScreen();
                Controller2.Screen.setCursor(1, 1); 
                Controller2.Screen.print("GAS THE JEWS");
                Controller2.rumble("-.");
           }
       ...
       lift.spin(vex::directionType::fwd, (Controller1.Axis2.value() - Controller1.Axis1.value()) , vex::velocityUnits::pct); //(Axis3+Axis4)/2
