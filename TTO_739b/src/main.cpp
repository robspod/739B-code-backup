...
void usercontrol( void ) {
  ...
  while (1) {
       ...
       Left.spin(vex::directionType::fwd, (Con.Axis3.value() + Con.Axis4.value())/speed , vex::velocityUnits::pct); 
       Right.spin(vex::directionType::fwd, (Con.Axis3.value() - Con.Axis4.value())/speed, vex::velocityUnits::pct);
